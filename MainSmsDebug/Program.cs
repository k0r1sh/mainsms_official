...
namespace MainSmsDebug
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //ResponsePrice response = mainSms.getMessagesPrice("mains3ms", "79609708097, 79545551232", "run at 23:00 olo+ + lo");

            // "236387643", "236395928"
            // ResponseSend response = mainSms.sendSms("mainsms", "79609708091", "test2 message +", DateTime.Parse("25.09.2020 23:00"));

           // ResponseStatus response = mainSms.getMessagesStatus("236422916, 236423069");

            // ResponseCancel response = mainSms.cancelMessages("236391787");

            // ResponseInfo response = mainSms.getPhonesInfo("79609708091, 9138857565");
